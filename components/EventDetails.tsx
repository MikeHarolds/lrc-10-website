        ...
        <Reveal className="overflow-hidden rounded-[20px] bg-green-900 text-white shadow-panel">
          <div className="grid lg:grid-cols-2">
            <div className="p-7 sm:p-10">
              <span className="eyebrow text-blue-bright">Event Details</span>
              ...
              <dl className="mt-8 space-y-6">
                {rows.map((row) => (
                  <div key={row.label} className="flex gap-4">
                    <span className="grid h-11 w-11 shrink-0 place-items-center rounded-xl border border-white/15 text-blue-bright">
                      <row.icon className="h-5 w-5" />
                    </span>
                    <div>
                      <dt className="text-xs font-bold uppercase tracking-[0.18em] text-blue-bright">
                        {row.label}
                      </dt>
            ...
            <div className="relative min-h-[300px] lg:min-h-[480px]">
              ...
              <div className="absolute inset-x-5 bottom-5 rounded-card bg-blue p-5 text-white sm:inset-x-auto sm:right-6 sm:max-w-xs">
