  ...
  return (
    ...
    >
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(60%_50%_at_50%_0%,rgba(255,109,0,0.14),transparent_65%)]" />
      </div>
      ...
      <div className="container relative max-w-3xl text-center">
        <Reveal>
          ...
          <span className="eyebrow">{finalCta.kicker}</span>
          ...
          <p className="mt-3 font-display text-lg font-bold uppercase tracking-[0.06em] text-gold sm:text-2xl">
            {finalCta.themeLine}
          </p>
