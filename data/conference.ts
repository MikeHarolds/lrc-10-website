  ...
  list: [
    {
      ...
      role: "President: Impactfield Leadership Institute",
    ...
    },
    {
      ...
      role: "Lead Pastor: Destiny Life Redemption Chapel, Enugu",
      focus: "Faith",
      photo: "/images/lrc/speakers/sam-iheanacho.jpg",
      photoPosition: "50% 14%",
      bio: [
        "Dr. Sam Iheanacho is the Lead Pastor of Destiny Life Redemption Chapel, Enugu, where he pursues his mandate of building a balanced life for people around the world. He is a sought-after conference speaker known for his unique approach to Scripture, public speaking, and coaching.",
        "A graduate of Federal Polytechnic, Oko with a degree in Business Administration, he holds a Doctorate in Strategic Leadership and Management from Learn to Live Business School, UK. He is a certified and licensed management consultant, and an alumnus of Daystar Leadership Academy.",
    ...
    },
    {
      id: "gozie-udemezue",
      status: "confirmed",
      name: "Dr. Gozie C. Udemezue",
      role: "Principal Solicitor: Gozie Udemezue Solicitors",
      focus: "Family",
      photo: "/images/lrc/speakers/gozie-udemezue.jpg",
      photoPosition: "50% 18%",
      bio: [
        "Dr. Gozie Udemezue is a Nigerian lawyer, development practitioner, and advocate for women's rights with over two decades of professional experience in law, leadership, and social impact.",
        "She obtained her LL.B from Enugu State University of Science and Technology (ESUT) in 1999 and later earned a Master of Laws (LL.M) in Human Rights Law from the University of London in 2015. She also holds a Certificate in International Human Rights from the International Institute for Human Rights, Strasbourg, France (2003), and a Ph.D. in peace and conflict studies. She is a fellow of the African Leadership Institute of West Africa under the Aspen Institute, Colorado.",
        "Ms. Udemezue began her career in the development sector, serving as a program and legal officer with Women's Aid Collective from 2001 to 2006, where she worked on women's rights and social justice initiatives. She is the principal solicitor at Gozie Udemezue Solicitors, a position she has held since 2001, and a senior associate with Ike, Ike & Associates, Enugu, since March 2016.",
        "She is the founder and executive member of Healing Hearts Widows Support Foundation Inc., established in 2008 to provide emotional, legal, and social support for widows. In 2022, she founded Blessed Widows Nigeria, a platform dedicated to strengthening widows through faith, empowerment, and advocacy. She is also the founder and lead coach of Wevolution Grief Coaching Services, supporting individuals through grief recovery and life rebuilding.",
        "Dr. Udemezue served as a vice chairman of Nigerian Bar Association, Oji River branch, and currently serves as the South East Regional Coordinator of the African Women Lawyers Association (AWLA) Nigeria. She sits on the Advisory Board of Kunie Foundation, Nigeria, and also on the board of Women Founders' Collective, U.S.A. since 2007 and three other non-profits based in Uganda, Nigeria, and the United Kingdom.",
        "Internationally recognized for her leadership, she participated in the International Visitors Leadership Program (IVLP) of the U.S. State Department in 2006 and was later named an IVLP Goldstar in 2017. She received the Danny Glover Award in New York in 2018 in recognition of her work and impact.",
        "In addition to her legal and advocacy work, Dr. Udemezue is a life coach and certified workshop facilitator and currently serves as Team Lead of the House of Refuge Worship and Retreat Center in Enugu.",
        "In 2007, she was conferred with the traditional title, Apunanwu Enugwu-Ukwu n'Umunri by His Royal Majesty, Igwe Osita Agwuna — this gives her a seat in the revered 'Otu Odueze Royal Society', the highest ranking body of female community leaders in her late husband's community.",
...
export const tickets = {
  ...
  tiers: [
    ...
    },
    {
      ...
      features: [
        "Networking Opportunities",
        "Access to all Events (Conference, Award Night and Masterclass)",
       "Access to Impactfield Value Bank",
      "Access to One Month Mentorship Program",
      "Reserved Seat at the General Event",
      "Certificate of Participation (ecopy)",
    ...
    },
    {
      ...
      features: [
       "Everything in Gold Ticket",
        "Professional Headshots at the Event",
        "Certificate of Participation (Hardcopy)",
        "A Copy of The Bold Leader book.",
        "A Customized Notepad",
  ...
  list: [
    {
      placeholder: true,
      quote:
        "Since 2023, Impactfield has transformed my mindset, strengthened my leadership capacity, and given me opportunities to discover and develop my potential. It has shaped how I lead, serve, and influence others. I am truly grateful for the growth, relationships, and experiences Impactfield has brought into my life.",
      name: "Chukwuma Obinna",
      role: "Creative Lead: The Anomalous Systems Ltd",
    },
    {
      placeholder: true,
      quote:
      ...
      name: "Micheal Onwusi",
      role: "Produduct Manager: Smart Transport Grid",
    },
    {
      placeholder: true,
      quote:
